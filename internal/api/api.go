...
func (s *Server) Routes() *http.ServeMux {
	...
	mux.HandleFunc("GET /api/c/{collection}/{slug}/history", s.history)
	mux.HandleFunc("GET /api/c/{collection}/{slug}/at/{hash}", s.versionAt)
	mux.HandleFunc("POST /api/c/{collection}/{slug}/restore", s.restore)
